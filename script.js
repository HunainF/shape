...
S.init();
// Fetch follower name from URL query parameters
document.addEventListener('DOMContentLoaded', () => {
    const urlParams = new URLSearchParams(window.location.search);
    const followerName = urlParams.get('name') || 'Follower';
    const targetElement = document.getElementById('follower-name');
    if (targetElement) {
        targetElement.textContent = `Thank you, ${followerName}!`;
    }
});
